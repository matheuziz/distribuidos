...
class LightsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create light" do
    assert_difference('Light.count') do
      post lights_url, params: { light: { brightness: @light.brightness, color: @light.color } }
    end
  ...
  test "should update light" do
    patch light_url(@light), params: { light: { brightness: @light.brightness, color: @light.color } }
