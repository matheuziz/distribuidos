...
class TvsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tv" do
    assert_difference('Tv.count') do
      post tvs_url, params: { tv: { channel: @tv.channel, status: @tv.status, volume: @tv.volume } }
    end
  ...
  test "should update tv" do
    patch tv_url(@tv), params: { tv: { channel: @tv.channel, status: @tv.status, volume: @tv.volume } }
